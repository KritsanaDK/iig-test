...
<body class="loading"
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 order-lg-2 order-xl-1">
                            <div class="card">
                                <div class="card-body">
                                    <form action="javascript:void(0);" id="id_profile2" enctype="multipart/form-data"
                                        method="post"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="hidden" class="form-control" id="userName"
                                                        name="userName" value="{{ json_decode($result)[0]->user_name }}"
                                                        pattern="[A-Za-z0-9_]+" required maxlength="12" minlength="4">
                                                    ...
                                                    <input type="text" class="form-control" id="userName2"
                                                        name="userName2"
                                                        value="{{ json_decode($result)[0]->user_name }}"
                                                        pattern="[A-Za-z0-9_]+" required maxlength="12" minlength="4"
                                                        disabled>
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" id="first_name" name="first_name"
                                                        class="form-control"
                                                        value="{{ json_decode($result)[0]->first_name }}" required
                                                        maxlength="60">
                                                    <span class="visible " id='valid_first_name'></span>
                                                </div>
                                                <label class="col-md-4 col-form-label">ความยาวไม่เกิน 60
                                                    ตัวอักษร
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" id="last_name" name="last_name"
                                                        class="form-control"
                                                        value="{{ json_decode($result)[0]->last_name }}"
                                                        maxlength="60">
                        ...
                        <div class="modal-content">
                            <div class="modal-body p-4">
                                <div class="text-center">
                                    ...
                                    <p class="mt-3">Password duplicate</p>
    ...
    <script type="text/javascript">
        ...
        image.src = "uploads/{{ json_decode($result)[0]->img_path }}";
        ...
        $("#show_hide_password2 i").on('click', function(event) {
            ...
            if ($('#show_hide_password2 input').attr("type") === "password") {
                ...
                $('#show_hide_password2 i').removeClass("mdi mdi-eye-off");
                $('#show_hide_password2 i').addClass("mdi mdi-eye");
            } else {
                $('#show_hide_password2 input').attr('type', 'password');
                $('#show_hide_password2 i').removeClass("mdi mdi-eye");
                $('#show_hide_password2 i').addClass("mdi mdi-eye-off");
            }
        });
        ...
        $('#btn_Submit').on('click', function(e) {
            ...
            // let a_4 = validate($('#first_name'), $('#valid_first_name'), /\w+$/i, '',
            //     'First Name ไม่ถูกต้อง');
        ...
        $("#confirm1").keyup(function(event) {
            event.preventDefault();

            let userName = $("#userName").val();
            let confirm1 = $("#confirm1").val();
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('register_checkPassword') }}",
                async: true,
                dataType: "json",
                data: {
                    "_token": "{{ csrf_token() }}",
